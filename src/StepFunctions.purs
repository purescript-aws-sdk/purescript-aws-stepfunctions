...
createActivity = Request.request service method  where
    service = Request.ServiceName "StepFunctions"
    method = Request.MethodName "createActivity"
...
createStateMachine = Request.request service method  where
    service = Request.ServiceName "StepFunctions"
    method = Request.MethodName "createStateMachine"


-- | <p>Deletes an activity.</p>
deleteActivity :: forall eff. DeleteActivityInput -> Aff (exception :: EXCEPTION | eff) DeleteActivityOutput
deleteActivity = Request.request service method  where
    service = Request.ServiceName "StepFunctions"
    method = Request.MethodName "deleteActivity"
...
deleteStateMachine = Request.request service method  where
    service = Request.ServiceName "StepFunctions"
    method = Request.MethodName "deleteStateMachine"
...
describeActivity = Request.request service method  where
    service = Request.ServiceName "StepFunctions"
    method = Request.MethodName "describeActivity"
...
describeExecution = Request.request service method  where
    service = Request.ServiceName "StepFunctions"
    method = Request.MethodName "describeExecution"
...
describeStateMachine = Request.request service method  where
    service = Request.ServiceName "StepFunctions"
    method = Request.MethodName "describeStateMachine"
...
describeStateMachineForExecution = Request.request service method  where
    service = Request.ServiceName "StepFunctions"
    method = Request.MethodName "describeStateMachineForExecution"
...
getActivityTask = Request.request service method  where
    service = Request.ServiceName "StepFunctions"
    method = Request.MethodName "getActivityTask"
...
getExecutionHistory = Request.request service method  where
    service = Request.ServiceName "StepFunctions"
    method = Request.MethodName "getExecutionHistory"
...
listActivities = Request.request service method  where
    service = Request.ServiceName "StepFunctions"
    method = Request.MethodName "listActivities"
...
listExecutions = Request.request service method  where
    service = Request.ServiceName "StepFunctions"
    method = Request.MethodName "listExecutions"
...
listStateMachines = Request.request service method  where
    service = Request.ServiceName "StepFunctions"
    method = Request.MethodName "listStateMachines"
...
sendTaskFailure = Request.request service method  where
    service = Request.ServiceName "StepFunctions"
    method = Request.MethodName "sendTaskFailure"
...
sendTaskHeartbeat = Request.request service method  where
    service = Request.ServiceName "StepFunctions"
    method = Request.MethodName "sendTaskHeartbeat"
...
sendTaskSuccess = Request.request service method  where
    service = Request.ServiceName "StepFunctions"
    method = Request.MethodName "sendTaskSuccess"


-- | <p>Starts a state machine execution.</p>
startExecution :: forall eff. StartExecutionInput -> Aff (exception :: EXCEPTION | eff) StartExecutionOutput
startExecution = Request.request service method  where
    service = Request.ServiceName "StepFunctions"
    method = Request.MethodName "startExecution"


-- | <p>Stops an execution.</p>
stopExecution :: forall eff. StopExecutionInput -> Aff (exception :: EXCEPTION | eff) StopExecutionOutput
stopExecution = Request.request service method  where
    service = Request.ServiceName "StepFunctions"
    method = Request.MethodName "stopExecution"
...
updateStateMachine = Request.request service method  where
    service = Request.ServiceName "StepFunctions"
    method = Request.MethodName "updateStateMachine"
